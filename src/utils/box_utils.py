...
from src.utils.misc import check_numpy_to_torch
from src.ops.utils import points_in_boxes_cpu
from src.utils.pclib import rotate_points_batch, rotation_mat2euler_torch
...
def boxes_to_corners_3d(boxes3d, order='lwh'):
    """
        4 -------- 5             ^ z
       /|         /|             |
      7 -------- 6 .             |
...
def corners_to_boxes_3d(corners, mode=9):
    """
        4 -------- 5             ^ z
       /|         /|             |
      7 -------- 6 .             |
