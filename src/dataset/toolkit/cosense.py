...
from src.utils import pclib
from src.ops.utils import points_in_boxes_cpu
from src.dataset.toolkit import register_pcds
...
class CoSenseDataConverter:
    ...
    def to_kitti(self, out_dir=None):
        from src.dataset.toolkit.kitti import type_cosense2kitti
        split = {
                ...
                for a, adict in fdict['agents'].items():
                    for l, ldict in adict['lidar'].items():
                        ...
                        for i, box in enumerate(boxes):
                            ...
                            # from src.utils.vislib import draw_points_boxes_plt, plt
...
if __name__=="__main__":
    ...
    # src.to_kitti("/koko/LUMPI/kitti_test")
    # src.to_sustech("/koko/LUMPI/lumpi_selected_sustech")
    # src.to_opv2v("/media/hdd/yuan/koko/data/LUMPI/opv2v_fmt")
    # src.update_from_sustech("/koko/LUMPI/sustech_fmt")
    # cosense.supervison_full_to_sparse(cosense.meta,
    #                                   '/koko/src/kitti-sparse-num534',
